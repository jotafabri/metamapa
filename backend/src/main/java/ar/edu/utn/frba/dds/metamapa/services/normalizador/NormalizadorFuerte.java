...
public class NormalizadorFuerte implements NormalizadorHecho {
    ...
    private final NormalizadorLigero normalizadorLigero; // para campos que solo requieren normalización ligera
    ...
    public Hecho normalizar(Hecho hecho) {
        ...
        hecho.setDescripcion(normalizadorLigero.normalizarDescripcion(hecho.getDescripcion()));
