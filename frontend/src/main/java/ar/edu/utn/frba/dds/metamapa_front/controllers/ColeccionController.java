...
public class ColeccionController {
  ...
  @GetMapping("/{handle}")
  public String listarHechos(@PathVariable String handle, Model model, RedirectAttributes redirectAttributes) {
    try{
      List<HechoDTO> hechos = coleccionService.getHechosByHandle(handle);
