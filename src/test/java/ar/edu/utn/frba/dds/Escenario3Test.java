...
public class Escenario3Test {
    ...
    public void init(){
        ...
        hechosAgregar.add(new Hecho("Brote de enfermedad contagiosa causa estragos en San Lorenzo, Santa Fe","Grave brote de enfermedad contagiosa ocurrió en las inmediaciones de San Lorenzo, Santa Fe. El incidente dejó varios heridos y daños materiales. Se ha declarado estado de emergencia en la región para facilitar la asistencia.",
                ...
                LocalDate.parse("05/07/2005", DateTimeFormatter.ofPattern("dd/MM/yyyy")).atStartOfDay(), Origen.CARGA_MANUAL));
    ...
    public void escenario3(){
        ...
        Assertions.assertTrue(coleccionPrueba.darHechos().stream().anyMatch(h -> h.getTitulo().equalsIgnoreCase("Brote de enfermedad contagiosa causa estragos en San Lorenzo, Santa Fe")),
        ...
        Assertions.assertFalse(
                coleccionPrueba.darHechos().stream().anyMatch(h -> h.getTitulo().equalsIgnoreCase("Brote de enfermedad contagiosa causa estragos en San Lorenzo, Santa Fe")),
