...
public class SeederServiceFuentesDinamicas implements ISeederServiceDinamica {
  ...
  public void initDinamicas() {
    ...
    var hechos = List.of(
        new Hecho("Tsunami Chile", "Descripcion de prueba 1", "Geologico", -34.6037, -58.3816, LocalDateTime.of(2010, 2, 27, 4, 00))
            .conContribuyente(contribuyente)
            .conEstado(Estado.ACEPTADA)
            .conMultimedia(new Multimedia(baseUrl, "/images/hechos/es-posible-un-tsunami-en-buenos-aires.jpg"))
            .build(),
        new Hecho("Incendio en el Bolson", "Descripcion de prueba 2", "Natural", -39.8143, -51.4446, LocalDateTime.of(2019, 11, 5, 14, 30))
            .conContribuyente(contribuyente)
            .conEstado(Estado.ACEPTADA)
            .conMultimedia(new Multimedia(baseUrl, "/images/hechos/_126544339_fuego12.jpg"))
            .build(),
        new Hecho("Ovnis en el Cerro Uritorco", "Descripcion de prueba 3", "Paranormal", -61.8413, -12.3346, LocalDateTime.of(2023, 12, 5, 14, 30))
            .conContribuyente(contribuyente)
            .conEstado(Estado.RECHAZADA)
